...
export function getDiagnostic () {
  ...
  str += ' температуру, сатурацию и глюкозу крови, а также рассчитать'
  str += ' индекс массы тела (ИМТ)'
  return str
}
...
export function getDisease () {
  let str = ''
  str += 'В данном разделе можно пройти опрос по симптомам болезней и определить риск развития заболевания'
  str += ''
  str += ''
  return str
}
