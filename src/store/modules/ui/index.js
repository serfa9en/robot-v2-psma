...
export default {
  ...
  actions: {
    ...
    setUserMail: ({ commit }, payload) => commit('SET_USER_MAIL', payload),
    ...
    setIsDiabetes: ({ commit }, payload) => commit('SET_IS_DIABETES', payload),
  ...
  mutations: {
    ...
    SET_USER_MAIL: (state, payload) => { state.user.mail = payload.data },
    ...
    SET_IS_DIABETES: (state, payload) => { state.user.isDiabetes = payload.data },
  ...
  getters: {
    ...
    getUserMail: state => state.user.mail,
    ...
    getIsDiabetes: state => state.user.isDiabetes,
